...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,162 | 🐛 242 | 🌐 Go | 📅 2026-07-19: A subdomain enumeration utility
* [SubFinder](https://github.com/subfinder/subfinder) ⭐ 14,429 | 🐛 8 | 🌐 Go | 📅 2026-09-14: SubFinder is a subdomain discovery tool that discovers valid subdomains for websites. Designed as a passive framework to be useful for bug bounties and safe for penetration testing.
...
* [Aiodnsbrute](https://github.com/blark/aiodnsbrute) ⭐ 676 | 🐛 4 | 🌐 Python | 📅 2023-10-22: Asynchronous DNS brute force utility
...
* [Certgraph](https://github.com/lanrat/certgraph) ⭐ 381 | 🐛 3 | 🌐 Go | 📅 2026-07-03: A tool to crawl the graph of certificate Alternate Names
...
* [Masscan](https://github.com/robertdavidgraham/masscan) ⭐ 26,013 | 🐛 414 | 🌐 C | 📅 2026-04-23: An asynchronously TCP port scanner
...
* [PwnedOrNot](https://github.com/thewhiteh4t/pwnedOrNot) ⭐ 2,643 | 🐛 6 | 🌐 Python | 📅 2026-03-28: Tool to find passwords for compromised accounts
