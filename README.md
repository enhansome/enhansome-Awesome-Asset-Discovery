...
* [rustbuster](https://github.com/phra/rustbuster) ⭐ 559 | 🐛 16 | 🌐 Rust | 📅 2023-07-21: Files, directories and vhost buster written in Rust.

## [↑](#contents)IP Address Discovery

* [Massdns](https://github.com/blechschmidt/massdns) ⭐ 3,647 | 🐛 14 | 🌐 C | 📅 2026-04-15: A DNS resolver utility for bulk lookups
* [DataSploit (IP Address Modules)](https://github.com/DataSploit/datasploit/tree/master/ip) ⭐ 3,316 | 🐛 107 | 🌐 Python | 📅 2025-11-20: An OSINT Framework to perform various recon techniques
...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,217 | 🐛 243 | 🌐 Go | 📅 2026-07-19: A subdomain enumeration utility
* [SubFinder](https://github.com/subfinder/subfinder) ⭐ 14,500 | 🐛 3 | 🌐 Go | 📅 2026-09-25: SubFinder is a subdomain discovery tool that discovers valid subdomains for websites. Designed as a passive framework to be useful for bug bounties and safe for penetration testing.
* [GoBuster](https://github.com/OJ/gobuster) ⭐ 14,159 | 🐛 24 | 🌐 Go | 📅 2026-09-09: Directory/File, DNS and VHost busting tool written in Go
...
* [Certgraph](https://github.com/lanrat/certgraph) ⭐ 383 | 🐛 3 | 🌐 Go | 📅 2026-07-03: A tool to crawl the graph of certificate Alternate Names
* [LDNS](https://github.com/NLnetLabs/ldns) ⭐ 360 | 🐛 87 | 🌐 C | 📅 2026-09-23: A DNS library useful for DNS tool programming
...
* [linkedin2username](https://github.com/initstring/linkedin2username) ⭐ 1,857 | 🐛 1 | 🌐 Python | 📅 2026-05-20: OSINT Tool: Generate username lists for companies on LinkedIn
...
* [Masscan](https://github.com/robertdavidgraham/masscan) ⭐ 26,035 | 🐛 415 | 🌐 C | 📅 2026-04-23: An asynchronously TCP port scanner
* [Zmap](https://github.com/zmap/zmap) ⭐ 6,384 | 🐛 11 | 🌐 C | 📅 2026-08-28: A fast network scanner designed for Internet-wide network surveys
...
* [MicroBurst](https://github.com/NetSPI/MicroBurst) ⭐ 2,443 | 🐛 5 | 🌐 PowerShell | 📅 2026-06-29: PowerShell based Azure security assessment scripts
* [ruler](https://github.com/sensepost/ruler) ⭐ 2,310 | 🐛 14 | 🌐 Go | 📅 2024-06-10 : A tool to abuse Exchange services
...
* [GCPBucketBrute](https://github.com/RhinoSecurityLabs/GCPBucketBrute) ⭐ 574 | 🐛 7 | 🌐 Python | 📅 2023-05-26: A Google Storage buckets enumeration script
...
* [PwnedOrNot](https://github.com/thewhiteh4t/pwnedOrNot) ⭐ 2,652 | 🐛 6 | 🌐 Python | 📅 2026-03-28: Tool to find passwords for compromised accounts
* [Scavenger](https://github.com/rndinfosecguy/Scavenger) ⭐ 838 | 🐛 1 | 🌐 Python | 📅 2026-09-24: Paste sites crawler (bot) looking for leaked credentials
...
* [Create an Issue](https://github.com/redhuntlabs/Awesome-Asset-Discovery/issues/new/choose) ⭐ 2,854 | 🐛 20 | 📅 2025-01-22.
* [Send us Pull Requests](https://github.com/redhuntlabs/Awesome-Asset-Discovery/pulls) ⭐ 2,854 | 🐛 20 | 📅 2025-01-22
...
This work is licensed under [**CC0 1.0 Universal**](https://github.com/redhuntlabs/Awesome-Asset-Discovery/blob/master/License.md) ⭐ 2,854 | 🐛 20 | 📅 2025-01-22
