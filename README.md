...
* [Massdns](https://github.com/blechschmidt/massdns) ⭐ 3,648 | 🐛 14 | 🌐 C | 📅 2026-04-15: A DNS resolver utility for bulk lookups
...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,226 | 🐛 243 | 🌐 Go | 📅 2026-07-19: A subdomain enumeration utility
* [SubFinder](https://github.com/subfinder/subfinder) ⭐ 14,505 | 🐛 3 | 🌐 Go | 📅 2026-09-25: SubFinder is a subdomain discovery tool that discovers valid subdomains for websites. Designed as a passive framework to be useful for bug bounties and safe for penetration testing.
* [GoBuster](https://github.com/OJ/gobuster) ⭐ 14,161 | 🐛 25 | 🌐 Go | 📅 2026-09-09: Directory/File, DNS and VHost busting tool written in Go
* [Sublist3r](https://github.com/aboul3la/Sublist3r) ⭐ 11,046 | 🐛 254 | 🌐 Python | 📅 2024-08-02: Subdomains enumeration tool with multiple sources
...
* [Masscan](https://github.com/robertdavidgraham/masscan) ⭐ 26,043 | 🐛 415 | 🌐 C | 📅 2026-04-23: An asynchronously TCP port scanner
* [Zmap](https://github.com/zmap/zmap) ⭐ 6,385 | 🐛 11 | 🌐 C | 📅 2026-08-28: A fast network scanner designed for Internet-wide network surveys
...
* [MicroBurst](https://github.com/NetSPI/MicroBurst) ⭐ 2,444 | 🐛 5 | 🌐 PowerShell | 📅 2026-06-29: PowerShell based Azure security assessment scripts
...
* [PwnedOrNot](https://github.com/thewhiteh4t/pwnedOrNot) ⭐ 2,653 | 🐛 6 | 🌐 Python | 📅 2026-03-28: Tool to find passwords for compromised accounts
...
* [Create an Issue](https://github.com/redhuntlabs/Awesome-Asset-Discovery/issues/new/choose) ⭐ 2,856 | 🐛 20 | 📅 2025-01-22.
* [Send us Pull Requests](https://github.com/redhuntlabs/Awesome-Asset-Discovery/pulls) ⭐ 2,856 | 🐛 20 | 📅 2025-01-22
...
This work is licensed under [**CC0 1.0 Universal**](https://github.com/redhuntlabs/Awesome-Asset-Discovery/blob/master/License.md) ⭐ 2,856 | 🐛 20 | 📅 2025-01-22
